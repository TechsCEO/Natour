...
var displayMap = function displayMap(locations) {
  ...
  var boundList = [];
  var popUp = L.popup();
  var map = L.map('map').setView([36.260462, 59.616754], zoomLevel);
  L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
    maxZoom: zoomLevel,
    attribution: '©OpenStreetMap'
  }).addTo(map);
  locations.forEach(function (loc) {
    var marker = L.marker([loc.coordinates[1], loc.coordinates[0]]).addTo(map);
    var bounds = [loc.coordinates[1], loc.coordinates[0]];
    boundList.push(bounds);
    marker.on('click', function (e) {
      popUp.setLatLng(e.latlng).setContent(loc.description).openOn(map);
    });
  });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          updateDataUrl = 'http://127.0.0.1:3000/api/v1/users/updateMe'; // showAlert('error', `${axios.toString()}`);
          _context.next = 5;
          return (0, _axios.default)({
            method: 'PATCH',
            url: updateDataUrl,
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./../../utils/catchAsync":"../../utils/catchAsync.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable*/
var stripe = Stripe('pk_test_51Np42nHgADyUNaBMasaI68X4AmBmup9CUVaheZfJEHX6nxjmW3Hbv5xEzRgQ1c0joEy2guZDW8oLURykMrmoePMz00tP6yut4V');
...
if (userDataForm) {
  var _ref;
  userDataForm.addEventListener('submit', function (_x) {
...
if (userPasswordForm) {
  var _ref2;
  userPasswordForm.addEventListener('submit', function (_x2) {
    return (_ref2 = _ref2 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
      var passwordCurrent, password, passwordConfirm, dataObj;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            event.preventDefault();
            ...
            _context2.next = 8;
            return (0, _updateSettings.updatePassword)(dataObj);
          case 8:
